...
int main(int argc, char **argv){
    ...
    // It's first three parameters are: data type, row, column Declare a 2*3 float matrix
    Matrix<float, 2, 3> matrix_23;

    // At the same time, Eigen provides many built-in types via typedef, but the bottom layer
    // is still Eigen::Matrix. For example, Vector3d is essentially
    ...
    // It should be explicity converted
    ...
    matrix_33 = Matrix3d::Random(); // randım Number Matrix
    ...
    // Solving equations
    // Whe solve the equation of matrix_NN * x = v_Nd
